...
function MeusPrestadores(props) {
  ...
  //   const load_prestador = () => {
  //     console.log("Botao funcionando!!!");
  //   };

  async function load_prestador() {
  ...
  return (
    <Form style={{ margin: "10px" }}>
      ...
      <h2>Listando Prestadores:</h2>
          ...
          <br/>
          <Button variant="primary" onClick={listarPrestador}>
              Listar Prestadoress
          </Button>{" "}
          <br/>
          <br/>
        ...
        <h3>Editando Prestadores:</h3>
          ...
          <br></br>
          <Button variant="primary" onClick={alterarPrestador}>
              Editar Segurado
          </Button>{" "}
          <Button variant="primary" onClick={deletarPrestador}>
              Remover Segurado
          </Button>{" "}
      </div>
    </Form>
...
export default MeusPrestadores;
